...
module.exports = class InitSchema1725327820709 {
    ...
    async up(queryRunner) {
        await queryRunner.query(`CREATE TABLE "comment_votes" ("voteId" uuid NOT NULL DEFAULT uuid_generate_v4(), "ipAddress" character varying NOT NULL, "value" integer NOT NULL DEFAULT '0', "comment_id" uuid, "tenant_id" uuid, CONSTRAINT "PK_7b3547bfeae2fbcfb4707a12a02" PRIMARY KEY ("voteId"))`);
        await queryRunner.query(`CREATE TABLE "comments" ("commentId" uuid NOT NULL DEFAULT uuid_generate_v4(), "author" character varying NOT NULL, "content" character varying NOT NULL, "postedAt" TIMESTAMP NOT NULL DEFAULT now(), "score" integer NOT NULL DEFAULT '0', "article_id" uuid, "tenant_id" uuid, CONSTRAINT "PK_b302f2e474ce2a6cbacd7981aa5" PRIMARY KEY ("commentId"))`);
        await queryRunner.query(`CREATE TABLE "images" ("imageId" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying NOT NULL, "url" character varying NOT NULL, "mimeType" character varying NOT NULL, "articleArticleId" uuid, "tenantTenantId" uuid, CONSTRAINT "REL_a4145c976b7c58095294caaefe" UNIQUE ("articleArticleId"), CONSTRAINT "REL_66e8d16c2f5df6024d6accde23" UNIQUE ("tenantTenantId"), CONSTRAINT "PK_ec459f275c64a5f69513745e0c8" PRIMARY KEY ("imageId"))`);
        ...
        await queryRunner.query(`ALTER TABLE "comment_votes" ADD CONSTRAINT "FK_9083225a23314d231d68abbd518" FOREIGN KEY ("tenant_id") REFERENCES "tenants"("tenantId") ON DELETE CASCADE ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "comments" ADD CONSTRAINT "FK_bae41308a2185399e6bec738b56" FOREIGN KEY ("tenant_id") REFERENCES "tenants"("tenantId") ON DELETE CASCADE ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "images" ADD CONSTRAINT "FK_66e8d16c2f5df6024d6accde23d" FOREIGN KEY ("tenantTenantId") REFERENCES "tenants"("tenantId") ON DELETE SET NULL ON UPDATE NO ACTION`);
    ...
    async down(queryRunner) {
        ...
        await queryRunner.query(`ALTER TABLE "images" DROP CONSTRAINT "FK_66e8d16c2f5df6024d6accde23d"`);
        await queryRunner.query(`ALTER TABLE "images" DROP CONSTRAINT "FK_a4145c976b7c58095294caaefe3"`);
        await queryRunner.query(`ALTER TABLE "comments" DROP CONSTRAINT "FK_bae41308a2185399e6bec738b56"`);
        await queryRunner.query(`ALTER TABLE "comments" DROP CONSTRAINT "FK_e9b498cca509147e73808f9e593"`);
        await queryRunner.query(`ALTER TABLE "comment_votes" DROP CONSTRAINT "FK_9083225a23314d231d68abbd518"`);
